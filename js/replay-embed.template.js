...
linkStyle('https:/style/font-awesome.css?');
linkStyle('https:/style/battle.css?a7');
linkStyle('https:/style/replay.css?a7');
linkStyle('https:/style/utilichart.css?a7');

requireScript('https:/js/lib/ps-polyfill.js');
requireScript('https:/config/config.js?a7');
requireScript('https:/js/lib/jquery-1.11.0.min.js');
requireScript('https:/js/lib/html-sanitizer-minified.js');
requireScript('https:/js/battle-sound.js');
requireScript('https:/js/battledata.js?a7');
requireScript('https:/data/pokedex-mini.js?a7');
requireScript('https:/data/pokedex-mini-bw.js?a7');
requireScript('https:/data/graphics.js?a7');
requireScript('https:/data/pokedex.js?a7');
requireScript('https:/data/moves.js?a7');
requireScript('https:/data/abilities.js?a7');
requireScript('https:/data/items.js?a7');
requireScript('https:/data/teambuilder-tables.js?a7');
requireScript('https:/js/battle-tooltips.js?a7');
requireScript('https:/js/battle.js?a7');
